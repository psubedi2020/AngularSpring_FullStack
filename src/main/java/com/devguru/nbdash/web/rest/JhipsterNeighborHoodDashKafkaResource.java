...
import com.devguru.nbdash.config.KafkaSseConsumer;
import com.devguru.nbdash.config.KafkaSseProducer;

@RestController
@RequestMapping("/api/jhipster-neighbor-hood-dash-kafka")
public class JhipsterNeighborHoodDashKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterNeighborHoodDashKafkaResource.class);
    ...
    public JhipsterNeighborHoodDashKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
